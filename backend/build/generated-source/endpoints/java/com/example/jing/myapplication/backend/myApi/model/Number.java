...
public final class Number extends com.google.api.client.json.GenericJson {

  @Override
  public Number set(String fieldName, Object value) {
    return (Number) super.set(fieldName, value);
  }
