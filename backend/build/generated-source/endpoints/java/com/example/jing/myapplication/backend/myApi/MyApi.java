...
package com.example.jing.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://pivotal-realm-162221.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.example.jing.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.jing.myapplication.backend.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "shopRequest".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link ShopRequest#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.example.jing.myapplication.backend.myApi.model.JsonObject}
   * @return the request
   */
  public ShopRequest shopRequest(com.example.jing.myapplication.backend.myApi.model.JsonObject content) throws java.io.IOException {
    ShopRequest result = new ShopRequest(content);
    initialize(result);
    return result;
  }

  public class ShopRequest extends MyApiRequest<com.example.jing.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "shopRequest";

    /**
     * Create a request for the method "shopRequest".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link ShopRequest#execute()} method to invoke the remote operation. <p>
     * {@link
     * ShopRequest#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param content the {@link com.example.jing.myapplication.backend.myApi.model.JsonObject}
     * @since 1.13
     */
    protected ShopRequest(com.example.jing.myapplication.backend.myApi.model.JsonObject content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.jing.myapplication.backend.myApi.model.MyBean.class);
    }

    @Override
    public ShopRequest setAlt(java.lang.String alt) {
      return (ShopRequest) super.setAlt(alt);
    }

    @Override
    public ShopRequest setFields(java.lang.String fields) {
      return (ShopRequest) super.setFields(fields);
    }

    @Override
    public ShopRequest setKey(java.lang.String key) {
      return (ShopRequest) super.setKey(key);
    }

    @Override
    public ShopRequest setOauthToken(java.lang.String oauthToken) {
      return (ShopRequest) super.setOauthToken(oauthToken);
    }

    @Override
    public ShopRequest setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ShopRequest) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ShopRequest setQuotaUser(java.lang.String quotaUser) {
      return (ShopRequest) super.setQuotaUser(quotaUser);
    }

    @Override
    public ShopRequest setUserIp(java.lang.String userIp) {
      return (ShopRequest) super.setUserIp(userIp);
    }

    @Override
    public ShopRequest set(String parameterName, Object value) {
      return (ShopRequest) super.set(parameterName, value);
    }
  }
